...
CIIE.Map.prototype.initialize=function(mapDivId,_hotspot,_ctrlPos,_ctx,_showInfoWins){
    ...
    if(LOCATECELL=="true"){
    	...
    	if(FROMMODEL!='ciie'){
            ...
            this.addCiieImage();
            //this.map.setView([31.19688, 121.311218], 17);
            this.map.setView([31.19688, 121.304218], 17);
...
CIIE.Map.prototype.initMarker=function(){
    ...
    this.markerBaseRoom_green = L.icon({
        iconUrl: this.ctx+'/static/styles/local-lsm/map/BaseRoom_green_g.png',
        iconSize: [48, 48]
    });
    ...
    this.markerAIRPLANE = L.icon({
        iconUrl: this.ctx+'/static/styles/local-lsm/map/airplane_green_g.png',
        iconSize: [128,128]
        //iconSize: [100,100]
    });
    this.markerTRAIN = L.icon({
        iconUrl: this.ctx+'/static/styles/local-lsm/map/train_green_g.png',
        iconSize: [128,128]
        //iconSize: [100,100]
    });
    this.markerHOTEL = L.icon({
        iconUrl: this.ctx+'/static/styles/local-lsm/map/hotel_green_g.png',
        iconSize: [100,100]
    });
    ...
    this.markerBaseStation=L.icon({
        iconUrl: this.ctx+'/static/styles/local-lsm/map/BaseStation_green_g.png',
        iconSize: [48, 48]
    });
...
CIIE.Map.prototype.getLocateContentHtml=function(name,show){
    ...
    var html='<div name="'+name+'" class="QLCONTENT" style="height:200px;display:'+display+';">'
                ...
                //if(name=='J-国家会展中心'){
                    ...
                    //  +'</div>'
                    //  +'<div class="QLCSmall_g" style="margin-left:10px;"></div>'
                    //  +'<div style="clear:both;"></div>'
                    // +'</div>'
                ...
                //      +'</div>'
                //      +'<div class="QLCMiddle_g" style="margin-left:10px;"></div>'
                //      +'<div style="clear:both;"></div>'
                //  +'</div>'
        ...
        $.ajax({
            ...
            function clickEvent(ee){
                ...
                var urlNew='../maptip/deviceDetailNew.jsp?hotspot='+encodeURIComponent(hotspot)
                        ...
                        +'&is_g='+encodeURIComponent('yes')    //  yes   no
                        +'&lacci='+encodeURIComponent(lacci)
...
CIIE.Map.prototype.createCtrlBtns=function(){
    ...
    var btnList='<div id="ctrlResource" class="mapCtrlContent" style="position:absolute;right:120px;bottom:10px;display:block;">'
                    +'<div style="width:100%;padding-left:10px;">'
                        ...
                        //99999 
                        +'<div class="ctrlTitle mapCtrlItem mapCtrlItemSelected" func="2G小区总数" style="float:left;margin: 9px 0px 0px 0px;padding-top: 10px;">2G小区<span class="ctrlCount" id="legendCount2GCell">0</span>个:</div>'
                        ...
                        +'<div class="ctrlTitle mapCtrlItem mapCtrlItemSelected" func="4G小区总数" style="float:left;margin: 9px 0px 0px 0px;padding-top: 10px;">4G小区<span class="ctrlCount" id="legendCountFDDAndTDD">0</span>个:</div>'
                        +'<div class="mapCtrlItemFontLeft">室外 | </div>'
                        +'<div class="mapCtrlItem mapCtrlItemSelected yjutreds" func="TDD-D"><div class="ctrlIconTDD-D"></div><div>4G-D</div><div style="clear:both;"></div></div>'
                        +'<div class="mapCtrlItem mapCtrlItemSelected yjutreds" func="TDD-E"><div class="ctrlIconTDD-E"></div><div>4G-E</div><div style="clear:both;"></div></div>'
                        +'<div class="mapCtrlItem mapCtrlItemSelected yjutreds" func="TDD-F"><div class="ctrlIconTDD-F"></div><div>4G-F</div><div style="clear:both;"></div></div>'
                        +'<div class="mapCtrlItem mapCtrlItemSelected yjutreds" func="FDD-S"><div class="ctrlIconFDD-S"></div><div>4G+</div><div style="clear:both;"></div></div>'
                        +'<div class="mapCtrlItemFontCenter"> &nbsp;&nbsp;&nbsp;&nbsp;室内 | </div>'
                        +'<div class="mapCtrlItem mapCtrlItemSelected yjutreds ttttttttt" func="TDD-D-C"><div class="ctrlIconTDD-D-C"><div class="ctrlIconTDD-D-C-N"></div></div><div>4G-D</div><div style="clear:both;"></div></div>'
                        +'<div class="mapCtrlItem mapCtrlItemSelected yjutreds ttttttttt" func="TDD-E-C"><div class="ctrlIconTDD-E-C"><div class="ctrlIconTDD-E-C-N"></div></div><div>4G-E</div><div style="clear:both;"></div></div>'
                        +'<div class="mapCtrlItem mapCtrlItemSelected yjutreds ttttttttt" func="TDD-F-C"><div class="ctrlIconTDD-F-C"><div class="ctrlIconTDD-F-C-N"></div></div><div>4G-F</div><div style="clear:both;"></div></div>'
                        +'<div class="mapCtrlItem mapCtrlItemSelected yjutreds ttttttttt" func="FDD-S-C"><div class="ctrlIconFDD-S-C"><div class="ctrlIconFDD-S-C-N"></div></div><div>4G+</div><div style="clear:both;"></div></div>'
                        +'<div class="mapCtrlItemFontRight"></div>'
                        +'<div style="clear:both;"></div>'
                        ...
                        +'<div class="mapCtrlItem " func="应急车"><div class="ctrlIconEMERCAR"></div><div>应急车<span class="ctrlCount" id="legendCountEC">0</span>辆</div><div style="clear:both;"></div></div>'
                        ...
                        +'<div class="mapCtrlItem" func="保障人员"><div class="map-icon-maintainman" style="width:40px;height:40px;"></div><div>保障人员<span class="ctrlCount" id="legendCountMM">0</span>人</div><div style="clear:both;"></div></div>'
...
//                      +'<div name="咪咕视频" class="mapCtrlItem"><div class="ctrlIconTOPAPP"></div><div>咪咕视频</div><div style="clear:both;"></div></div>'
                ...
                +'<div target="ctrlResource" class="ctrlResource mapCtrlBtns glowSelected" style="position:absolute;right:30px;bottom:518px;"></div>'
                //+'<div target="ctrlPerformance" class="ctrlPerformance mapCtrlBtns" style="position:absolute;right:30px;bottom:433px;"></div>'
                +'<div target="ctrlFunction" class="ctrlFunction mapCtrlBtns" style="position:absolute;right:30px;bottom:433px;"></div>'
                //+'<div target="ctrlTopology" class="ctrlTopology mapCtrlBtns" style="position:absolute;right:30px;bottom:350px;"></div>'
    ...
    if (FROMMODEL == null || FROMMODEL == "null"){
        ...
        $("#ctrlResource").find('.mapCtrlItem[func="基站"]').addClass('mapCtrlItemSelected');  //默认显示基站
...
CIIE.Map.prototype.updatePercent=function(_hotspot){
    ...
    //if(_hotspot=='J-外滩'){
		...
		var qlcTypeClass1 = "QLCSmall_g";   //优
		var realPercent = 95;
		var  qlcTypeClass2 = "QLCSmall_g";
		var  leftPercent2 = 95;
            ...
            for (var i = 0; i < data.length; i++) {
                ...
                if(_hotspot.indexOf(currObj.scene_name) !=-1){
                   ...
                   if (30<leftPercent2 && leftPercent2<70) {
                       ...
                       // qlcTypeClass2 = "QLCBig_g";
                   };
                   if (70<leftPercent2 && leftPercent2<90) {
                       qlcTypeClass2 = "QLCOk";
                       // qlcTypeClass2 = "QLCMiddle_g";
                   };
                   if (90<leftPercent2) {
                       qlcTypeClass2 = "QLCNice";
                       // qlcTypeClass2 = "QLCSmall_g";
                   };
...
CIIE.Map.prototype.showModel=function(){
    ...
    if(display=='hidden'){
        ...
        $('#modelFrame').attr('src','../ciienew/unity/unityplayer/unityplayer.html?smooth='+$.cookie('dataSmooth'));
    }else{
...
//                      if(name.indexOf('嘉里中心')==-1) continue;
                        ...
                        var marker = null;
                        //if ( station_type ==null  || (station_type.indexOf('宏站') <0 && station_type.indexOf('街道站') <0 && station_type.indexOf('室内') <0)) {
                        if (false) {
                            count_6++;
            ...
            //if (FROMMODEL == null || FROMMODEL == "null"){}else{
                ...
                //this.getDialTests(31.1978,121.29884);      //拨测
                //this.getDialTests(31.18891,121.30516);      //拨测
            ...
            if (FROMMODEL == null || FROMMODEL == "null"){    //概览大屏
                ...
                this.map.addLayer(this.markersLayerBaseStation);
                //$("#ctrlResource").find('.mapCtrlItem[func="基站"]').trigger('click');
...
CIIE.Map.prototype.getMaintainManBak = function() {
    ...
    $.ajax({
        ...
        // //添加 dom
        // var selfPopupStr = '';
        //     selfPopupStr += '<div id="bzry_" style="position:absolute;top:50%;left:50%;margin-top:-378px;margin-left:-575px;width:1150px;height:796px;overflow:hidden;display:none;">'
        ...
        //     selfPopupStr += '<div id="bzryClose_" class="map-icon-close" style="position:absolute;right:5px;top:5px;"></div>';
        //     selfPopupStr += '</div>';

        //     $('#map').parent().append(selfPopupStr);
        //     $('#bzryClose_').on('click',function(){
        //         $('#bzry_').hide();
        //     });
