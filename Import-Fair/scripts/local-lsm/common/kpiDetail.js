...
KpiComponent.DetailQuery.prototype.streamCellData;
KpiComponent.DetailQuery.prototype.wsCellData;

KpiComponent.DetailQuery.prototype.isHot;

KpiComponent.DetailQuery.prototype.CELLNAME;
KpiComponent.DetailQuery.prototype.CELLTYPE="4g";
KpiComponent.DetailQuery.prototype.LAC;
KpiComponent.DetailQuery.prototype.CI;
KpiComponent.DetailQuery.prototype.HOTSPOT;
KpiComponent.DetailQuery.prototype.STATION;

KpiComponent.DetailQuery.prototype.showCellKpi=function(){
	var dm=LSMScreen.DataManager.getInstance();
	var lacci=this.LAC+":"+this.CI;
	dm.getCellsStreamKpiByCells({laccis:[lacci]},this.streamCellDataHandler.bind(this));
};

KpiComponent.DetailQuery.prototype.showHotspotKpi=function(){
	this.isHot=true;
	var dm=LSMScreen.DataManager.getInstance();
	dm.getHotSpotsKpis([this.HOTSPOT],null,null,this.streamDataHandler.bind(this));
};
KpiComponent.DetailQuery.prototype.showStationKpi=function(){
	this.isHot=true;
	var dm=LSMScreen.DataManager.getInstance();
	dm.getMetroStationsKpi([this.STATION],null,null,this.streamDataHandler.bind(this));
};

KpiComponent.DetailQuery.prototype.streamDataHandler=function(data){
	this.streamData=data[this.HOTSPOT];
	var dm=LSMScreen.DataManager.getInstance();
	var param={
	...
	dm.getHotSpotTrafficFlow(param,this.wsDataHandler.bind(this));
};

KpiComponent.DetailQuery.prototype.wsDataHandler=function(data){
	this.wsData=data;
	new KpiComponent.CellDetail(this.wsData,this.streamData,this.HOTSPOT);	
};

KpiComponent.DetailQuery.prototype.streamCellDataHandler=function(data){
	this.streamCellData=data[this.LAC+":"+this.CI];
	var dm=LSMScreen.DataManager.getInstance();
	...
	dm.getHotSpotTrafficFlow(param,this.wsCellDataHandler.bind(this));
};

KpiComponent.DetailQuery.prototype.wsCellDataHandler=function(data){
	this.wsCellData=data;
	new KpiComponent.CellDetail(this.wsCellData,this.streamCellData,this.CELLNAME);
};




KpiComponent.CellDetail=function (wsData,streamData,title,CELLTYPE)
{
...
KpiComponent.CellDetail.prototype.cols=[
  	...
  	{colName:'总用户数',name : '总用户数',index : '总用户数',width : KpiComponent.CellDetail.baseKpiColWidth,unit:'人'}
  ];
...
KpiComponent.CellDetail.prototype.showRecordAllKpis=function(wsData,streamData,title){
