...
DisneyComponent.DetailQuery=function(){
	
};
DisneyComponent.DetailQuery.prototype.streamData;
DisneyComponent.DetailQuery.prototype.wsData;

DisneyComponent.DetailQuery.prototype.streamCellData;
DisneyComponent.DetailQuery.prototype.wsCellData;

DisneyComponent.DetailQuery.prototype.isHot;

DisneyComponent.DetailQuery.prototype.CELLNAME;
DisneyComponent.DetailQuery.prototype.CELLTYPE="4g";
DisneyComponent.DetailQuery.prototype.LAC;
DisneyComponent.DetailQuery.prototype.CI;
DisneyComponent.DetailQuery.prototype.HOTSPOT;

DisneyComponent.DetailQuery.prototype.showCellKpi=function(){
...
DisneyComponent.DetailQuery.prototype.showHotspotKpi=function(){
	this.isHot=true;
	var dm=LSMScreen.DataManager.getInstance();
	dm.getHotSpotsKpis([this.HOTSPOT],null,null,this.streamDataHandler.bind(this));
};

DisneyComponent.DetailQuery.prototype.streamDataHandler=function(data){
...
DisneyComponent.DetailQuery.prototype.wsDataHandler=function(data){
	this.wsData=data;
	new DisneyComponent.CellDetail(this.wsData,this.streamData,this.HOTSPOT);	
};

DisneyComponent.DetailQuery.prototype.streamCellDataHandler=function(data){
...
DisneyComponent.DetailQuery.prototype.wsCellDataHandler=function(data){
	this.wsCellData=data;
	new DisneyComponent.CellDetail(this.wsCellData,this.streamCellData,this.CELLNAME);
};




DisneyComponent.CellDetail=function (wsData,streamData,title,CELLTYPE)
{
