    ...
    initLoad:function(){
      ...
      //  internetTV.loadEchartsDataOfBarBar();
       ...
       // internetTV.loadEchartsDataOfTvService('migu');
    	...
    	//internetTV.initTime("echartsadd_04");
    	//internetTV.loadEchartsDataLineAll();
          ...
          var endMin = new Date(hour_date.getTime() - 1 * 60 * 60 * 1000);
        ...
        $.ajax({
                ...
                success : function(data) {
                    ...
                    if (resultArr!=null) {
                    	...
                    	if(currEcharts=="echartsadd_04"){
                        	eastcom_echarts_ott.loadDataToChart("echartsadd_04",HUAWEI_FENGHUO); 

                    	}else if(currEcharts=="echartsadd_10"){
                        	eastcom_echarts_ott.loadDataToChart("echartsadd_10",ottHUAWEI);  //华为总
                    	}else if(currEcharts=="echartsadd_06"){
                        	eastcom_echarts_ott.loadDataToChart("echartsadd_06",ottFENGHUO);  //烽火总
                    	}else if(currEcharts=="echartsadd_08"){
                        	eastcom_echarts_ott.loadDataToChart("echartsadd_08",ottJieFENGHUO);  //烽火子
                    	}else if(currEcharts=="echartsadd_07"){
                        	eastcom_echarts_ott.loadDataToChart("echartsadd_07",ottJieHUAWEI);  //华为子
                    	}else if(currEcharts=="echartsadd_11"){
                        	eastcom_echarts_ott.loadDataToChart("echartsadd_11",ottMiGuHUAWEI);  //华为咪咕
                    	}else if(currEcharts=="echartsadd_12"){
                        	eastcom_echarts_ott.loadDataToChart("echartsadd_12",ottMiGuFENGHUO);  //烽火咪咕 
