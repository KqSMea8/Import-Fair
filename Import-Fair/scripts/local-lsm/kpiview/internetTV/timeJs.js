function CONTENTHTMLOFCOMMON_add(currEcharts){
	var htmlStr="";
	if("echartsadd_11"==currEcharts||"echartsadd_13"==currEcharts){
		htmlStr = '<div style="">'
            +     '<div style="padding-left: 10px;">' 
            +        '<span style="color:#fff;font-size:16px">开始时间</span><span style="color:#fff;padding:0px 5px">:</span>' 
            +        '<input id="startTime_'+currEcharts+'" class="Wdate TimeFiled" style="width: 160px;height: 24px;color: #fff;cursor: pointer;font-size: 16px;" onclick="WdatePicker({dateFmt : \'yyyy-MM-dd HH:mm\',maxDate:\'%y-%M-{%d}\'})"/>'
            +     '</div>'
            +     '<div style="padding-left: 10px;padding-top: 5px;">' 
            +        '<span style="color:#fff;font-size:16px;;">结束时间</span><span style="color:#fff;padding:0px 5px">:</span>' 
            +        '<input id="endTime_'+currEcharts+'" class="Wdate TimeFiled" style="width: 160px;height: 24px;color: #fff;cursor: pointer;font-size: 16px;" onclick="WdatePicker({dateFmt : \'yyyy-MM-dd HH:mm\',maxDate:\'%y-%M-{%d}\'})"/>'
            +        '<input name="'+currEcharts+'" style="margin-left:10px;margin-top: -6px;" type="button" class="btn btn-success btn-xs" value="确定">'
            +     '</div>'
           // +     '<div style="padding-top: 20px;text-align:center;">'
            //+     '</div>'
            +  '</div>';
	}else if("echartsadd_12"==currEcharts){
		 htmlStr = '<div style="">'
	            +     '<div style="padding-left: 10px;">' 
	            +        '<span style="color:#fff;font-size:16px">开始时间</span><span style="color:#fff;padding:0px 5px">:</span>' 
	            +        '<input id="startTime_'+currEcharts+'" class="Wdate TimeFiled" style="width: 160px;height: 24px;color: #fff;cursor: pointer;font-size: 16px;" onclick="WdatePicker({dateFmt : \'yyyy-MM-dd\',maxDate:\'%y-%M-{%d}\'})"/>'
/*	            +        '<span style="color:#fff;font-size:16px;margin-left:20px;">结束时间</span><span style="color:#fff;padding:0px 5px">:</span>' 
*//*	            +        '<input id="endTime_'+currEcharts+'" class="Wdate TimeFiled" style="width: 160px;height: 24px;color: #fff;cursor: pointer;font-size: 16px;" onclick="WdatePicker({dateFmt : \'yyyy-MM-dd HH:mm\',maxDate:\'%y-%M-{%d}\'})"/>'
*/	            +        '<input name="'+currEcharts+'" style="margin-left:10px;margin-top: -6px;" type="button" class="btn btn-success btn-xs" value="确定">'
	            +     '</div>' 
	           // +     '<div style="padding-top: 20px;text-align:center;">'
...
function CONTENTHTMLOFCOMMON(currEcharts){
	...
	if(currEcharts.indexOf("_re")==-1){
		 htmlStr = '<div style="">'
            ...
            +        '<input id="startTime_'+currEcharts+'" class="Wdate TimeFiled" style="width: 123px;height: 24px;color: #fff;cursor: pointer;font-size: 16px;" onclick="WdatePicker({dateFmt : \'yyyy-MM-dd\',maxDate:\'%y-%M-{%d} 23\'})"/>' 
		...
		if("echartsadd_11_re"==currEcharts||"echartsadd_13_re"==currEcharts){
			htmlStr = '<div style="">'
	            +     '<div style="padding-left: 10px;">' 
	            +        '<span style="color:#fff;font-size:16px">开始时间</span><span style="color:#fff;padding:0px 5px">:</span>' 
	            +        '<input id="startTime_'+currEcharts+'" class="Wdate TimeFiled" style="width: 160px;height: 24px;color: #fff;cursor: pointer;font-size: 16px;" onclick="WdatePicker({dateFmt : \'yyyy-MM-dd HH:mm\',maxDate:\'%y-%M-{%d}\'})"/>'
	           ...
	           // +     '<div style="padding-top: 20px;text-align:center;">'
	            //+     '</div>'
	            +  '</div>';
		}else if("echartsadd_12_re"==currEcharts){
			 htmlStr = '<div style="">'
		            +     '<div style="padding-left: 10px;">' 
		            +        '<span style="color:#fff;font-size:16px">开始时间</span><span style="color:#fff;padding:0px 5px">:</span>' 
		            +        '<input id="startTime_'+currEcharts+'" class="Wdate TimeFiled" style="width: 160px;height: 24px;color: #fff;cursor: pointer;font-size: 16px;" onclick="WdatePicker({dateFmt : \'yyyy-MM-dd\',maxDate:\'%y-%M-{%d}\'})"/>'
        ...
        if (addBigWinOfTimeAddCommon['win_'+currEcharts] == null) {
               ...
               $(addBigWinOfTimeAddCommon['win_'+currEcharts].content).find(":button").on('click',function(evt){
                if($(evt.currentTarget).val()=="确定"){
                    ...
                    if(whatType.indexOf("_re")==-1){
                    	 if (whatType == "echartsadd_01"||whatType == "echartsadd_02"||whatType == "echartsadd_03") {
                         	internetTV.loadEchartsDataOfIndex(whatType);
                         }else if (whatType == "echartsadd_04"||whatType == "echartsadd_05"||whatType == "echartsadd_06"){
                         	internetTV.loadEchartsDataOfTvService('tv',whatType);
                         }else if (whatType == "echartsadd_07"||whatType == "echartsadd_08"||whatType == "echartsadd_09"){
                         	internetTV.loadEchartsDataOfTvService('migu',whatType);
                         }else if (whatType == "echartsadd_10"){
                         	internetTV.loadEchartsDataOfTvService('content',whatType);
                         }
                    }else{
                    	if("echartsadd_12_re"==whatType){
                            //internetTV.loadEchartsDataOfTvService('migu','echartsadd_12_re');
                        }else{
