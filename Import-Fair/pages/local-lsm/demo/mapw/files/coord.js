...
var nameMapReverse={};
var worldGeoCoord={'上海':[121.4648,31.2891]};
for(var key in nameMap){
	nameMapReverse[nameMap[key]]=key;
}
for(var i=0;i<worldCoordData.length;i++){
	var record=worldCoordData[i];
	var name=record.name;
	var point=record.value;
	worldGeoCoord[nameMapReverse[name]]=point;
}