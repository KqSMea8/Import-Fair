...
if(!"true".equals(isScreenMode)){
	request.getRequestDispatcher("areaMonitor2_small.jsp?hotspotId="+hotspotId).forward(request, response);
}
%>
...
<div class="Disney_C">
    ...
    <div class="disney_centre">
    	<div class="DC1">
        <div class="title_Logo"><img src="${ctx}/static/styles/local-lsm/${hotspot}/images/title.png" /><span class="subtitleSpan" style="font-size:72px;color:white;line-height:72px;position:absolute;top:30px;"></span></div>
        ...
        <div class="DC2">
        	...
        	<div class="filesDivParent">
	        	...
	        	<div id="topDiv" style="float:right;margin-top:10px;margin-right:108px;display:none;">
...
SUtils.initCommonScene(function(){
	...
	$(".subtitleSpan").text(LSMConsts.area);
});
