...
<div style="width:100%;height:100%;padding:0px;">
		<div class="horizontalRow" style="width:100%;">
			<div class="horizontalRow" style="width:940px;height:380px;float:left;">
				...
				<div class="horizontalRow" style="background-color: rgba(0,102,255,0.10);height:280px;">
					...
					<div class="horizontalRow" style="width:30%;text-align: center;cursor:pointer" id="allCustomer_id">
						<div style="width:100%;">
					...
					<div class="horizontalRow" style="width:35%;text-align: center; margin-top: 10px;cursor:pointer" id="media_cust_cnt_id" onclick="_click(this)">
						<div style="width:100%;">
					...
					<div class="horizontalRow" style="width:35%;text-align: center;margin-top: 10px;cursor:pointer" id="spline_hall_id" onclick="_click(this)">
						<div style="width:100%;">
					...
					<div class="horizontalRow" style="width:30%;text-align: center;margin-top: 10px;cursor:pointer" id="media_line_cnt_id" onclick="_click(this)">
						<div style="width:100%;">
				...
				<div class="horizontalRow" style="height:220px;margin-top:40px;">
					<div class="horizontalRow" style="width:48%;">
						<div class="horizontalRow" style="width:100%;line-height:48px;">
							<div class="gc-icon-spfault" style="margin-right:20px;"></div>
							<div class="fontContentTitle">故障概况</div>
						</div>
						<div class="horizontalRow" style="width:100%;cursor:pointer;background-color: rgba(0,102,255,0.10);" id="faultSpline_id" onclick="_click(this)">
							...
							<div class="gc-mark-faultline" style="margin-left:0;width:128px;height:128px;"></div>
						</div>
					</div>
					<div class="horizontalRow" style="width:48%; margin-left:4%;">
						<div class="horizontalRow" style="width:100%;line-height:48px;">
							<div class="gc-icon-spcomplain" style="margin-right:20px;"></div>
							<div class="fontContentTitle">投诉概况</div>
						</div>
						<div class="horizontalRow" style="width:100%;cursor:pointer;background-color: rgba(0,102,255,0.10);" id="complainSpline_id" onclick="_click(this)">
							...
							<div class="gc-mark-complain" style="margin-left:0;width:128px;height:128px;"></div>
						</div>
					</div>
				</div>
				...
				<div style="width:100%;height:400px;margin-top:40px;">
					...
					<div class="ciiecontent" style="height:380px;padding:65px 0px 0px 0px;">
...
<div class="modal fade" id="Modal" style="position:absolute;">
	<div class="modal-dialog"
		style="width: 900px; height: 900px; margin: 20px auto;">
		<div class="modal-content">
			...
			<div class="modal-body" id="modal-body">
				<div  style="height: 900px; width: 830px;border: solid 1px #2431ac;margin:20px;background-color: rgba(0,4,66,0.75);border-radius: 15px;">
					<div id="spline_chart0_model" style="height: 880px; width: 830px;margin-top:20px"></div>
				</div>
			</div>
		</div>
	</div>
...
<script type="text/javascript" src="${ctx}/scripts/local-lsm/spline_g/spline_g_left.js"></script>
