...
<div class="bodybackground" style="overflow:hidden;">
	<div style="float:left;width:2000px;height:100%;padding:40px;">
		<div style="width:100%;">
			<div class="horizontalRow" style="width:940px;height:380px;float:left;">
				...
				<div class="horizontalRow">
					<div class="horizontalRow" style="width:50%;">
			...
			<div class="ciiepanel" style="width:940px;height:380px;float:left;">
				<div class="ciietitle">
					<div class="gc-icon-scale"></div>
					<div>保障规模</div>
				</div>
	...
	<div class="blockCenter" style="position:relative;width:2400px;height:100%;padding:0;">
		<div class="mapFrame" style="width:100%;height:100%;position:relative;">
		...
		<div class="gc-topobg" style="position:absolute;left:1%;bottom:40px;width:98%;margin-top:40px;" >
	...
	<div class="blockRight" style="width:2000px;padding:40px;" >
		<div style="width:100%;">
	...
	<div class="screentitle">
		...
		<div style="clear:both;"></div>
		<div id="screenTitleTime" class="titleTime" style="text-indent:0px;">
		</div>
	</div>
</div>
