...
<iframe id="leftIFrame" src="roamleft.jsp?isScreenMode=true" frameborder="0" style="float:left;width:2000px;height:1200px;"></iframe>
<iframe id="mapIFrame" src="roamcentersvg.jsp?isScreenMode=true" frameborder="0" style="float:left;width:2400px;height:1200px;"></iframe>
<iframe id="rightIFrame" src="roamright.jsp?isScreenMode=true" frameborder="0" style="float:left;width:1550px;height:1200px;"></iframe>
...
<script>
var BASEPATH="${ctx}";
new CIIENEW.Navigator('漫游保障');
function updateHotspot(hotspot,bool){
	...
	iframeWindow.updateHotspot(hotspot,bool);
}
...
function showRoamLeft(isPermenent,bool,roamType){
	var iframe0=$("#leftIFrame")[0];
	var iframeWindow=iframe0.window?iframe0.window:iframe0.contentWindow;
	iframeWindow.updateHotspot(isPermenent,bool,roamType);
}

function showRoamRight(isPermenent,bool){
	var iframe0=$("#rightIFrame")[0];
	var iframeWindow=iframe0.window?iframe0.window:iframe0.contentWindow;
	iframeWindow.updateHotspot(isPermenent,bool);
}
...
var overviews4="";
var overviews4_="";
window.clearInterval(overviews4);
window.clearInterval(overviews4_);
overviews4=setInterval(function() {
	overviews.init();
},300*1000);
overviews4_=setInterval(function() {
	overviews.Schedule();
},60*60*1000);
</script>
</html>