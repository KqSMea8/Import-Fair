package baidu.subway.ui.info 
{
    ...
    public class TransInfo extends flash.display.Sprite
    {
        ...
        private function init():void
        {
            ...
            while (loc4 < loc5) 
            {
                if (this._infoObj["lidTo"].indexOf(this._jsArr[loc4]["lid"]) != -1) 
                {
                    ...
                    loc6.x = 2;
                    loc6.y = this._lbSt.height + 59 + 18 * loc1;
        ...
        private function drawTransInfo():void
        {
            var loc1:*=new StationIcon();
            loc1.x = 8;
            loc1.y = this._lbSt.height + 19;
            this._info.addChild(loc1);
            var loc2:*=new flash.text.TextFormat("Arial", 12, 0);
            var loc3:*=new flash.text.TextField();
            loc3.text = "换乘";
            loc3.autoSize = "left";
            loc3.selectable = false;
            loc3.setTextFormat(loc2);
            loc3.x = loc1.x + loc1.width / 2 + 2;
            loc3.y = this._lbSt.height + 9;
            this._info.addChild(loc3);
            var loc4:*=new flash.text.TextFormat("Arial", 12, this._infoObj["lcTo"]);
            var loc5:*=new flash.text.TextField();
            loc5.text = this._infoObj["lbTo"];
            loc5.autoSize = "left";
            loc5.selectable = false;
            loc5.setTextFormat(loc4);
            loc5.x = loc3.x + loc3.width - 2;
            loc5.y = loc3.y;
            this._info.addChild(loc5);
            var loc6:*=new flash.text.TextField();
            loc6.text = "距离";
            loc6.autoSize = "left";
            loc6.selectable = false;
            loc6.setTextFormat(loc2);
            loc6.x = loc5.x + loc5.width - 2;
            loc6.y = loc3.y;
            this._info.addChild(loc6);
            var loc7:*=new flash.text.TextFormat("Arial", 12, 16731648);
            var loc8:*=new flash.text.TextField();
            loc8.text = this._infoObj["distance"];
            loc8.autoSize = "left";
            loc8.selectable = false;
            loc8.setTextFormat(loc7);
            loc8.x = loc6.x + loc6.width - 2;
            loc8.y = loc3.y;
            this._info.addChild(loc8);
            var loc9:*=new flash.text.TextField();
            loc9.text = "米";
            loc9.autoSize = "left";
            loc9.selectable = false;
            loc9.setTextFormat(loc2);
            loc9.x = loc8.x + loc8.width - 2;
            loc9.y = loc3.y;
            this._info.addChild(loc9);
            return;
        }
        ...
        private function drawLineIcon():void
        {
            ...
            loc2.text = this._infoObj["lbTo"];
            loc2.autoSize = "left";
            loc2.selectable = false;
            loc2.setTextFormat(loc1);
            var loc3:*=new flash.display.Sprite();
            loc3.graphics.lineStyle(1, this._infoObj["lcTo"], 1);
            loc3.graphics.beginFill(this._infoObj["lcTo"]);
        ...
        private function drawDirections():void
        {
            ...
            while (loc3 < loc4) 
            {
                if (this._infoObj["lidTo"].indexOf(this._jsArr[loc3]["lid"]) != -1) 
                {
                    loc5 = new SIcon();
                    loc5.x = this._maxWidth + 20;
                    loc5.y = this._lbSt.height + 66 + 20 * loc1;
                    this._info.addChild(loc5);
                    loc6 = new flash.text.TextField();
                    ...
                    loc6.y = this._lbSt.height + 61 + 20 * loc1;
                    this._info.addChild(loc6);
                    loc7 = new EIcon();
