package baidu.subway.symbol.line 
{
    ...
    public class HKDongTieLineSymbol extends Object implements baidu.subway.symbol.ISymbol
    {
        public function HKDongTieLineSymbol(arg1:flash.display.Sprite, arg2:uint, arg3:Boolean, arg4:Array)
        {
            super();
            this._shp = arg1;
        ...
        public function drawResult(... rest):flash.display.DisplayObject
        {
            ...
            while (loc14 < loc15) 
            {
                ...
                if (loc20 == 169 && loc21 == -311) 
                {
                    loc13.lineStyle(this.LN_WIDTH_RESULT, baidu.subway.util.Util.NOT_USED_COLOR);
                }
                else if (loc20 == 132 && loc21 == -311) 
                {
                    loc13.lineStyle(this.LN_WIDTH_RESULT, this._lc);
                }
                if (loc14 != 0) 
                ...
                if (loc19.stationVO.st) 
                {
                    ...
                    else 
                    {
                        ...
                        if (loc19.stationVO.iu) 
                        {
                            loc31.graphics.lineStyle(this.ST_CIRCLE_BORDER, this._lc);
                        }
                        else 
                        {
                            loc31.graphics.lineStyle(this.ST_CIRCLE_BORDER, baidu.subway.util.Util.NOT_USED_COLOR);
                        }
