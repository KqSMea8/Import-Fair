...
<%@ include file="/common/bootstrap.jsp"%> 
	...
	<body class="bgC">
		...
		<div style="padding:40px;z-index:101;position:absolute;left:40px;top:110px;display:block;">
			<div id="infoPanel" class="map-info-win" style="display:none;">
			...
			<div id="infoPanel2" class="map-info-win" style="display:none;margin-top:20px;" >
				<div class="map-info-win-title">
					<span >J-7H 指标概览</span>
				</div>
			...
			<div id="legend" class="map-info-win" style="display:none;overflow:hidden;margin-top:20px;height:72px;" >
...
["中国博览会会展中心C0NL18W_140","1","4G"]
			...
			function init() {
				...
				var pos={x:9.730019044081628,y:20.570868093033003,z:-35.657433473227975};
				...
				loader.load( 'models/fbx/outdoor.fbx', function ( object ) {
					...
					object.traverse(function(obj){
						...
						if(obj.name=='northGroundSection'||obj.name=='southGroundSection'){//northGroundSection southGroundSection
							//obj.visible=false;
						}
