...
<div class="screentitle_s" style="display:none;width:100%;height:100px;position:relative;">
	...
	<div class="bgL">
		<div style="width:100%;height:40px;margin-top:-40px;font-size:40px;margin-bottom:20px;color:#66E6FF"><span>区域概览</span><img  id="ciie_img" src="${ctx}/static/images/overview/k_1-1.png" style="margin:0 7px;height:40px;cursor:pointer;"><span>场景导航</span></div>
		<div class="horizontalRow example" style="width: 1326px; height: 400px;margin-right:24px;position: relative;">
		...
		<div style="width: 570px; height: 400px; float: right;position:relative;">
		...
		<div class="horizontalRow example" style="width: 875px; height: 250px; margin-top: 50px;margin-right:24px;">
		...
		<div class="horizontalRow example" style="width: 1018px; height: 250px; margin-top: 50px;position:relative;">
			<div class="horizontalRow ft-carousel" style="line-height: 68px;" id="carousel_3">
				...
				<div class="fontContentTitle" style="left:70px;top: -15px;z-index:10;position: absolute;">重要网站</div>
				 ...
				 <div onmouseover="Roll_img_onmouseover('bz_zywz');" onmouseout ="Roll_img_mouseout('bz_zywz')" style="font-size: 20px;float: right; color: #fff;cursor:pointer;z-index: 10; top:-10px;position: absolute;left: 420px;">
				...
				<div style="right: 220px;height: 40px;z-index:10;position: absolute;" onmouseover="img_onmouseover('bz_zywz');" onmouseout ="img_mouseout('bz_zywz')"><img id="bz_zywz_img" onclick="_model('bz_zywz')" style="cursor:pointer;margin-top: -35px;visibility:hidden"></div><div id="bz_zywz_switch"></div><br/>
				<div id="bz_zywz"></div>
			</div>
		</div>
		...
		<div class="horizontalRow"
			style="width: 1460px; height: 355px; margin-top: 45px; margin-left: 24px;position:relative;">
			<div class="horizontalRow" style="line-height: 68px;">
				<div style="width: 48px; height: 48px; background-size: 100% 100%; margin-top: -20px;">
