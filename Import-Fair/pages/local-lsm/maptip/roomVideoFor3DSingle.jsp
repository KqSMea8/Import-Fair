...
$(function(){
	 var html='<div id="roomVideo" class="liveVideo_big" style="display:block;left:0 !important;top:0 !important;width:100%;height:100%;">'
         ...
         +'<div id="roomVideoTitleBar" class="liveVideoTitleBar_big">'
             ...
             +'<div style="float: left;"><span id="roomVideoTitleSpan" class="videoTitleSpan_big">'+room.replace('MK','').replace('NC','')+'机房</span></div>'
     ...
     var url='../videoOfMachineRoom/videoOfMachineRoom.jsp?isScreenMode=true&roomName='+room+'&videoWidth='+width+'&videoHeight='+height;
 	
		$('#frameDiv').html(html);
		$('#roomVideoIframe').width(width-50);
		$('#roomVideoIframe').height(height-50);
