...
<iframe id="leftIFrame" src="overviewleft.jsp?isScreenMode=true" frameborder="0" style="float:left;width:2000px;height:1200px;"></iframe>
<iframe id="mapIFrame" src="../ciienew/ciiecenter.jsp?isScreenMode=true" frameborder="0" style="float:left;width:2400px;height:1200px;"></iframe>
...
var overviews3="";
var overviews3_="";
window.clearInterval(overviews3);
window.clearInterval(overviews3_);
overviews3=setInterval(function() {
	overviews.init();
},300*1000);
overviews3_=setInterval(function() {
	overviews.Schedule();
},60*60*1000);
</script>
</html>