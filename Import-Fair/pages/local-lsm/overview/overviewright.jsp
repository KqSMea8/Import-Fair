	...
	<div class="modal-dialog"
		...
		<div class="modal-content">
			<div class="modal-header">
				<h4 class="modal-title" style="font-size: 40px;text-align: center;"><span style="margin-right: 20px;">语音话务量</span><span style="font-size: 26px;" id="hul_ecarts_Modal_company"></span></h4>
			</div>
...
<script type="text/javascript" src="${ctx}/scripts/local-lsm/overview/overviews2.js"></script>
