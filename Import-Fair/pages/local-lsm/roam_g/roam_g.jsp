...
<iframe id="leftIFrame" src="roam_g_left.jsp?isScreenMode=true" frameborder="0" style="float:left;width:1000px;height:1050px;"></iframe>
<iframe id="mapIFrame" src="roam_g_center.jsp?isScreenMode=true" frameborder="0" style="float:left;width:1500px;height:1050px;"></iframe>
<iframe id="rightIFrame" src="roam_g_right.jsp?isScreenMode=true" frameborder="0" style="float:left;width:1000px;height:1050px;"></iframe>
...
<script>
var BASEPATH="${ctx}";
new CIIENEW.Navigator('集团返迁=漫游保障');
function updateHotspot(hotspot,roamType){
	...
	iframeWindow.updateHotspot(hotspot,roamType);
